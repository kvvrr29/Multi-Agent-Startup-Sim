 ...
 */
export default function CloudProjectList({ compact = false, activeId = null, onOpen }) {
  ...
  return (
    <div style={{ marginBottom: compact ? 0 : '2rem', textAlign: 'left' }}>
          ...
          return (
            <div
              ...
              style={{
                ...
                background: isActive ? 'rgba(67, 56, 202, 0.15)' : 'rgba(0,0,0,0.2)',
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>
                  {isActive ? 'Currently open' : `Updated ${new Date(p.updated_at).toLocaleString()}`}
                </div>
              </div>
              {!isActive && (
                <button
